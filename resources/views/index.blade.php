...
<section class="landing-page w-100 h-100 position-absolute top-0 start-0 py-5 " id="home">
    <div class="position-absolute top-50 start-50 translate-middle z-2 text-center text-xl-start">
        ...
        <div
            class="d-flex justify-content-between align-items-center mt-5 text-white align-items-center text-center flex-column flex-md-row">
            <div>
...
<section class="container">
    <div class="row py-5">
        <div class="col-12 col-lg-6">
            ...
            <iframe class="mx-auto d-block my-5 w-100 rounded-3 binaa-vid" height="300"
            ...
            <div class="card my-5 flex-row d-flex align-items-center px-3 py-5 border-0 shadow-sm">
                ...
                <div class="controls">
                    <button class="btn btn-dark audio-btn ms-3"
                            style="width: 150px"
                            aria-labelledby="congressvideo"
                            onclick="wavesurfer.playPause()">
                        <i class="fa-duotone fa-play-pause">
                        </i>
                    </button>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 col-lg-4 ">
                <div class="card text-center rounded-3  border-0 shadow-sm">
                    <div class="card-body p-5">
                        ...
                        <p class="card-text lh-lg">أن يكون مؤتمرنا الثاني منبراً للأنطلاقة نحو تثبيت المكتسبات
                            السياسية، و المشاركة الفعالة.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="card text-center rounded-3  border-0 shadow-sm">
                    <div class="card-body p-5">
                        ...
                        <p class="card-text lh-lg">إبراز أهمية العمل السياسي و النضال الحزبي، وأثرهما في تفعيل
                            التنافسية الشريفة وسبل التنمية.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="card text-center rounded-3  border-0 shadow-sm">
                    <div class="card-body p-5">
                        ...
                        <p class="card-text lh-lg">
                            حزب وطني محافظ يعمل من أجل البناء المتكامل لتحقيق الإصلاح والتنمية الشاملة في إطار
                            مرجعية الأمة الجزائرية ويسعى لرفاهية المجتمع وإسعاده.
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="card text-center border-0 rounded-3 shadow-sm fency-border p-3">
                            <div class="card-body">
                                ...
                                <a href="{{asset('assets/books/8.pdf')}}" class="btn text-primary fw-bolder " download>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="card text-center border-0 rounded-3 shadow-sm fency-border p-3">
                            <div class="card-body">
                                ...
                                <a href="{{asset('assets/books/7.pdf')}}" download class="btn text-primary fw-bolder ">
                                    <i class="fa-duotone fa-download text-primary me-1"></i>
                                    تحميل
                                </a>
                            </div>
...
<section class="my-5 book-ads">
    <div class="image position-relative">
        <img src="{{asset('assets/imgs/banner.webp
')}}"
             alt=""
             style="height:400px"
        ...
        <div class="row mt-5">
            ...
            <div class="col-sm-6 col-md-4 text-center">
                <div class="_df_thumb"
                     ...
                     thumb="{{asset('assets/books/1.webp')}}">
            ...
            <div class="col-sm-6 col-md-4 text-center">
                <div class="_df_thumb"
                     ...
                     thumb="{{asset('assets/books/2.webp')}}">
            ...
            <div class="col-sm-6 col-md-4 text-center">
                <div class="_df_thumb"
                     ...
                     thumb="{{asset('assets/books/3.webp')}}">
            ...
            <div class="col-sm-6 col-md-4 col  text-center">
                <div class="_df_thumb"
                     ...
                     thumb="{{asset('assets/books/4.webp')}}">
            ...
            <div class="col-sm-6 col-md-4 col  text-center">
                <div class="_df_thumb"
                     ...
                     thumb="{{asset('assets/books/5.webp')}}">
            ...
            <div class="col-sm-6 col-md-4  col  text-center">
                <div class="_df_thumb"
                     ...
                     thumb="{{asset('assets/books/6.webp')}}">
                ...
                <div class="swiper-wrapper">
                    @foreach($category->posts as $post)
                        <div class=" swiper-slide">
                            ...
                            <div
                                class="card Catpost h-100 position-relative text-bg-dark border-0 shadow-sm overflow-hidden"
...
<section class="container my-5 py-5">
    ...
    <div class="row align-items-center mt-5 text-lg-start text-center">
        <div class="col-lg-4 order-1 offset-lg-1">
            <img src="{{asset('assets/imgs/CiC.png')}}"
                 alt=""
                 class="img-fluid w-25 mb-3">

            <p>مركز الجزائر الدولي للمؤتمرات - عبد اللطيف رحال هو مجمع متعدد الاستخدامات مخصّص لإستضافة أكبر
                الاجتماعات الدولية في الجزائر، يتربع على مساحة 28 هكتارا، ويتواجد في الضاحية الغربية لمدينة الجزائر
                على مسار الطريق الوطني رقم 11 ببلدية سطاوالي.</p>
        ...
        <div class="col-lg-6 mb-lg-0 mb-5">
            <div id="carouselExample"
                 class="carousel slide w-100 rounded-3 border-5 border-success overflow-hidden">
                <div class="carousel-inner"
                     style="max-height: 250px">

                    <div class="carousel-item active">
                        <img src="{{asset('assets/imgs/1.webp')}}"
                             class="d-block w-100"
                             alt="...">
                    </div>

                    <div class="carousel-item">
                        <img src="{{asset('assets/imgs/2.webp')}}"
                             class="d-block w-100"
                             alt="...">
                    </div>

                    <div class="carousel-item">
                        <img src="{{asset('assets/imgs/3.webp')}}"
                             class="d-block w-100"
                             alt="...">
                    </div>

                    <div class="carousel-item">
                        <img src="{{asset('assets/imgs/4.webp')}}"
                             class="d-block w-100"
                             alt="...">
                    </div>

                    <div class="carousel-item">
                        <img src="{{asset('assets/imgs/5.webp')}}"
                             class="d-block w-100"
                             alt="...">
                    </div>

                    <div class="carousel-item">
                        <img src="{{asset('assets/imgs/6.webp')}}"
                             class="d-block w-100"
                             alt="...">
                    </div>
                </div>
...
<section class="my-5 py-5 bg-secondary-subtle">
    <div class="contact-infos mb-5 container ">
        ...
        <div class="row pt-5 m-0">
            ...
            <div class=" col-lg-7 p-0 rounded-3 overflow-hidden">
                <iframe class="w-100"
                        src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d12784.23117225001!2d2.8938568!3d36.769181!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x128fbb1f42a26a4b%3A0x9249d33297a3820a!2z2KfZhNmF2LHZg9iyINin2YTYr9mI2YTZiiDZhNmE2YXYpNiq2YXYsdin2Kog2LnYqNivINin2YTZhNi32YrZgSDYsdit2KfZhA!5e0!3m2!1sar!2sdz!4v1679792420128!5m2!1sar!2sdz"
                        height="420"
                        style="border:0;"
...
<script src="https://cdn.jsdelivr.net/npm/wavesurfer@1.3.4/dist/wavesurfer.min.js"
        integrity="sha256-B2DSOcI3KgAQF+3n12V/UTQ1pOTuDY4OH3euAAxDjQY="
